...
public class EventoController {
    ...
    @PutMapping("/")
    public ResponseEntity<Long> update(@RequestBody EventoEntity oNewEventoEntity) {
        return new ResponseEntity<Long>(oEventoService.update(oNewEventoEntity), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Page<EventoEntity>> getPage(
            ...
            @RequestParam(name = "tipoevento", required = false) Long lTipoevento) {
        return new ResponseEntity<Page<EventoEntity>>(oEventoService.getPage(oPageable, strFilter, lTipoevento), HttpStatus.OK);
    }
}
